...
for i in range(args.repeats):
    file_name = f'logs/classification/{args.name}_{i}/ue_ood_{acquisition_str}{covariance_str}.pickle'
    print(file_name)
...
plt.savefig(f"data/conf_ood_{args.name}_{args.acquisition}{covariance_str}", dpi=150)
plt.show()
